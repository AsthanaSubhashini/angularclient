    ...
    $scope.search = function(){
        ...
        $http(
				...
				).success(function(data,status,headers,config)
			{
				...
				console.log("$scope.rec"+$scope.rec[1].name);
			return $scope.rec;
				/*console.log("Received Data is = "+received);*/
			
			/*for(var i = 0;i<data.length;i++)
				{
					console.log("in loop" +data[i].name);
				}
			console.log(data[0].name);
			console.log(data[0].trainId);
				console.log(data[1].name);
				console.log(data[1].trainId)*/
